...
public class Dots2 extends JFrame implements MouseMotionListener, MouseListener {
	...
	public Dots2(String serverAddress) {
		inputName.setColumns(10);
		//Customize button play
	ImageIcon imageIconPlay = new ImageIcon("C:\\Users\\nhyen.RD\\Desktop\\candy.png");
...
//	    btnPlay.setBorder(BorderFactory.createBevelBorder(0, Color.green, Color.orange, Color.red, Color.blue)); //Four Colors Outer Bevel
	    ...
	    ImageIcon imageIconQuit = new ImageIcon("C:\\Users\\nhyen.RD\\Desktop\\mint.png");
	  ...
	  //Customize button start
	  		ImageIcon imageIconStart = new ImageIcon("C:\\Users\\nhyen.RD\\Desktop\\watermelon.png");
...
//                }
	...
	public void paintStatus(Graphics g) {
		...
		String status2 = players.get(PLAYER_ONE) + ": " + scores[0];
		String status3 = players.get(PLAYER_TWO) + ": " + scores[1];
		String status4 = players.get(PLAYER_THREE) + ": " + scores[2];
		String status5 = players.get(PLAYER_FOUR) + ": " + scores[3];
	...
	private String getUserName() {
		return JOptionPane.showInputDialog(frame, "Choose a display name:", "Username selection",
				JOptionPane.PLAIN_MESSAGE);
	}

	private String getColor() {

		return JOptionPane.showInputDialog(frame, "Choose a display color(" + colorList + "):",
				"Color selection", JOptionPane.PLAIN_MESSAGE).toUpperCase();
	}

	private int getDotSize() {
		return Integer.parseInt(JOptionPane.showInputDialog(frame, "Enter the number of dots in Rows and Colums:",
...
//							if(players.size() < 2) startGameBtn.setEnabled(false);
					...
					if(activePlayer == selectedKey) {
						activePlayer++;
						if(activePlayer>players.size()) activePlayer = 1;
					}
				}
